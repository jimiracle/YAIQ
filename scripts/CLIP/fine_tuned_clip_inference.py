...
# fine_tuned_model_path = "../models/fine_tuned_clip"
fine_tuned_model_path = "../models/fine_tuned_clip_large_patch14"
model = CLIPModel.from_pretrained(fine_tuned_model_path).to(device)
...
batch_size = 64
# dataloader = DataLoader(labels, batch_size=batch_size, shuffle=False)
...
print(f"Selected label in finetuned CLIP: {selected_label}")