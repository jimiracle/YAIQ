...
for i in range(560):
    ...
    question_dir = os.path.join(preprocess_dataset_path, 'vcog-bench/raven', str(i))
    ...
    choice_dir = os.path.join('/home/work/yaiq/datasets/vcog-bench/raven', str(i), 'choice')    
...
df.to_csv('../csv/raven_dataset.csv', index=False)